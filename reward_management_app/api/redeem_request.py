...
def create_redeem_request(customer_id, redeemed_points):
    try:
        ...
        current_redeem_points = frappe.get_value("Carpenter", customer_id, "redeem_points")
        ...
        frappe.db.set_value("Carpenter", customer_id, {
            ...
            "redeem_points": updated_redeem_points,
        })
        ...
        return _("Redeem Request created successfully. Points have been deducted.")
