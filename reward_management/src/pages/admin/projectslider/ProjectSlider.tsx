...
const Project: React.FC = () => {
    ...
    console.log("project response",response)
                ...
                if (response && response.data?.message?.project_image) {
                    const images = response.data.message.project_image;
                    const url = response.data.message.project_url;
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post(
                '/api/method/reward_management_app.api.projects.add_project',
                { new_image_url: uploadedFileURLs, projectUrl: prijectUrl }, 
                {
                    headers: {
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-x-6 p-6">
                <div className="col-span-12 flex justify-between items-center">
                    <h2 className="text-[var(--primaries)] box-title text-[.9375rem] font-bold">Projects</h2>
                    <button
                ...
                <h3 className="text-center text-defaulttextcolor box-title text-[.9375rem] font-bold mb-4">
                        ...
                        <div className='p-3 w-full rounded-[10px] text-defaulttextcolor text-sm border border-[#dadada]'>{projectUrl}</div>
                </div>
