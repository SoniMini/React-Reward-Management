            ...
            {showFromDate && (
                <div className='flex '>
                    <DatePicker
                        ...
                        className="outline-none focus:outline-none focus:ring-0 no-outline focus:border-[#dadada] mb-[0.25rem] text-[0.8rem] ti-form-control form-control-sm rounded-sm mr-2 p-0 py-[3px] px-2"
                    />
                ...
                <div className='flex '>
                    <input
                        className="outline-none focus:outline-none focus:ring-0 no-outline focus:border-[#dadada] mb-[0.25rem] text-[0.8rem] ti-form-control form-control-sm rounded-sm"
                        type="text"
